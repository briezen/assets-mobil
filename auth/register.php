...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $result = $conn->query("INSERT INTO users (name, username, password) 
              VALUES ('$name', '$username', '$hashed_password')");

    if ($result) {
        echo '<script>alert("Registrasi berhasil! Selamat datang, ' . $username . '."); window.location.href = "../pages/dashboard.php";</script>';
        exit;
    } else {
...
<head>
    ...
    <title>Register - MobilFlow</title>
    ...
    <div id="auth">
        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    <div class="auth-logo">
                        <a href="../pages/dashboard.php"><img src="../assets/compiled/svg/logo.svg" alt="Logo"></a>
                    </div>
